...
namespace DoConvert
{
    ...
    public class OfficeParser
    {
        ...
        /// <returns>转换是否成功</returns>
        public static bool ConvertExcelToPdf(string sourceFileName, string targetFileName)
        {
        ...
        public static bool ConvertPowerPointToPdf(string sourceFileName, string targetFileName)
        {
            ...
            try
            {
                using (System.IO.Stream stream = new System.IO.FileStream(sourceFileName, System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.ReadWrite))
                {
                    Aspose.Slides.Presentation pptx = new Aspose.Slides.Presentation(sourceFileName);
        ...
        public static bool PDFConvertToSwf(string pdfPath, string swfPath)
        {
            int page = GetPageCountByPDF(pdfPath);
